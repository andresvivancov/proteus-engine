...
case class ChainedStreamPredictor[T <: StreamTransformer[T], P <: StreamPredictor[P]](transformer: T, predictor: P)
...
object ChainedStreamPredictor {
  ...
  implicit def chainedFitOperation[L <: StreamTransformer[L], R <: StreamPredictor[R], I, T](implicit
    fitOperation: StreamFitOperation[L, I],
    transformOperation: TransformDataStreamOperation[L, I, T],
    predictorFitOperation: StreamFitOperation[R, T]): StreamFitOperation[ChainedStreamPredictor[L, R], I] = {
