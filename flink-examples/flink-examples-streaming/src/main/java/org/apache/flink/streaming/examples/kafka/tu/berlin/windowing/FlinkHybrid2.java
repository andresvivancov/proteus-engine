...
public class FlinkHybrid2 {
	...
	//Creation of the SideInput
		...
		kafkaProps.setProperty("auto.offset.reset", "latest"); //earliest OK , latest
...
//								t.f11, millis,seconds,(System.currentTimeMillis()-t.f12));
	...
	//	taxiside.writeAsText("/home/andresviv/out/fin.txt", FileSystem.WriteMode.OVERWRITE).setParallelism(1);

		taxiside.writeAsText("/home/andresviv/out/fin.txt", FileSystem.WriteMode.OVERWRITE);
