 ...
 *
 */
public class FlinkWindowFromKafkavFinal7 {
	...
	// set up streaming execution environment
		 ...
		 */
	//Read from Historical Data
		DataStream<String> historicalData = env.readTextFile("flink-examples/flink-examples-streaming/src/main/resources/nyc200000.txt");
	//Mapping of the ID
...
/**
		...
		DataStream<Tuple15<Long,Boolean,String,String,Float,Float,Float,Float,Short,Long,Double,Long, Long, Long, Long>>
			...
			;
*/
		DataStream<Tuple15<Integer,Boolean,String,String,Float,Float,Float,Float,Short,Long,Double,Long, Long, Long, Long>>
			taxiside = resultSideInputandKafkaStream
			//rides
			...
			//.reduce(new Aggregations.SumAllValues(),new Aggregations.TSExtractor())
			.map(new Aggregations.MapToMeanR())
